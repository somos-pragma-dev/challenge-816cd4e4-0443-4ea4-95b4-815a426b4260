...
- Seniority: junior-l1
- Tipo: practical
- Título: Desarrollo de Microservicio REST
- Tiempo estimado: 8 horas

### Fases (trabajo del HUMANO — PROHIBIDO completarlas)
No implementes estos entregables. Dejalos como hueco pedagógico. El asistente solo materializa el proyecto arrancable para que el participante pueda trabajar.
- Fase 1: Definición del Modelo de Datos — objetivo: Definir y validar el modelo de datos para los clientes. — entregable (NO resolver): Modelo de datos definido y validado.
- Fase 2: Implementación del Microservicio REST — objetivo: Implementar el microservicio REST para gestionar los clientes. — entregable (NO resolver): Microservicio REST implementado y funcional.
- Fase 3: Pruebas y Optimización — objetivo: Realizar pruebas y optimizar el microservicio. — entregable (NO resolver): Microservicio REST optimizado y con pruebas unitarias y de integración.
...
// === ARCHIVO: src/main/java/com/fintech/clientservice/application/ClientService.java ===
...
// === ARCHIVO: src/main/java/com/fintech/clientservice/domain/Client.java ===
package com.fintech.clientservice.domain;
...
// === ARCHIVO: src/main/java/com/fintech/clientservice/infrastructure/ClientRepository.java ===
...
// === ARCHIVO: src/main/java/com/fintech/clientservice/infrastructure/ClientController.java ===
package com.fintech.clientservice.infrastructure;
...
// === ARCHIVO: src/test/java/com/fintech/clientservice/ClientServiceTest.java ===
